...
<html lang="pt-br">
  <head>
    ...
    <title>Conselho Fiscal - FNCC</title>
    <meta name="title" content="Conselho Fiscal - FNCC">
          ...
          <div class="topo-telas">
              <div class="container-fluid">
                  <div class="row align-content-center text-center">
                      <div class="col-12" >
                          <h1 class="titulo-topo">Conselho Fiscal</h1>
                      </div>
                  </div>
              </div>
          </div>
          <section class="espacamento equipe">
              <div class="container">
                  <div class="row mb-3">
                      <div class="col-12">
                          <h3 class="fw-bold">Conselho <span class="destaque">Efetivo<span></h3>
                      </div>
                  ...
                  <div class="row mb-3">
                      <div class="col-12">
                          <h3 class="fw-bold">Conselho <span class="destaque">Suplente<span></h3>
                      </div>
                      <div class="col-12 col-l col-md-4">
                          <div class="card">
                              <div class="card-body">
