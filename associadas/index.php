...
<link href="https://fonts.googleapis.com/css2?family=Exo:wght@100;200;300;400;500;600;700;900&family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,300&family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Raleway:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
  ...
  <body>
      ...
      <div class="conteudo-tela">
          ...
          <section class="espacamento associadas mb-5">
              <div class="container">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDI NESTLÉ</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://cooperjohnson.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPER JOHNSON</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://cogem.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COGEM</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://www.aspacer.com.br/hotsite/coopaspacer/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPASPACER</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://www.credivista.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDVISTA</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.cooperabril.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERATIVA ABRIL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://coopakzonobel.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOP AKZONOBEL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://www.cooperativacredito.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPCARGIL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.cooperalesp.com.br/site/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERALESP</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://cooperalpina.com/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERALPINA</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.coopericsson.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPER AVIBRAS</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://cooperbombril.com.br/home" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERBOMBRIL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://coopercredcba.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">	COOPERCRED CBA</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.fcav.unesp.br/#!/servicos/cooperfac/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERFEIS</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://cooperfemsa.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERMEL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.cooperabb.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERMC</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://coopernitro.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERPPG</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://coopersekurit.com.br/sitev2/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPER SEKURIT</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://anossacooperativa.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">	COOP FECOM / SESC/ SENAC</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://cooperskf.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERSKF</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.coopertel.org.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPERTEL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://coopermsd.com.br/cooperativa/coopermsd.aspx" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPHARMA</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.coopincor.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPINCOR</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.coopluiza.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPRICLAN</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://cooprb.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">COOPSELENE</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://www.rc.unesp.br/coopunesp/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">VILLARES METALS</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.colorado.com.br/nosdacolorado/category/credcol/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDCOL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="http://www.afam.com.br/crediafam/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDIAFAM</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.basf.com/br/pt/who-we-are/cooperativa-financeira-dos-colaboradores-do-grupo-basf.html" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDICEBRACE</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.credifisco.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDIFISCO</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.crediscoop.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDISCOOP</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://coopcredita.com.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
    ...
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDIUNIFI</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://credmil.org.br/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
      ...
      <div class="nome-associada">
        <h5 class="card-title">CREDMIL</h5>
                      ...
                      <div class="col cards-associadas">
                          <a href="https://www.grupofleury.coop.br/portal/" target="blank" alt="cooperativas ">
<div class="card h-100">
    <div class="p-1">
